...
- [ ] Simulated cluster outage triggers the external dead-man's switch — the
      switch itself is deployed and pings successfully on a healthy cluster
      (above), but a real outage has not actually been simulated against it
