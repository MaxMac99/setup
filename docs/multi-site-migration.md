...
- [ ] CNPG WAL archiving verified; a PITR restore rehearsed into a scratch cluster
      — `homelab-k8s`/Pulumi work, out of scope for this repo, still open
